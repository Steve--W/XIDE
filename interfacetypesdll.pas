...
TLaunchHTMLPage=procedure(DataString:String) of object;                         stdcall;
...
TDeleteSelectedTreeNode=procedure(TreeName:string) of object;             stdcall;
...
TGetGPUParam3DNumValue=function(GPUName,pName:String):T3DNumArray of object;                          stdcall;
...
TSetGPUParam3DNumValue=procedure(GPUName,pName:String;pValue:T3DNumArray) of object;                        stdcall;
...
setgpuparam3Dnumvalue:TSetGPUParam3DNumValue;
...
begin
  ...
  setgpuparam3Dnumvalue:=@appmethods.mmiSetGPUParam3DNumValue;
